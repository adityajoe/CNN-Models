...
class TrainModel():
    ...
    def __init__(self, parameters):
        ...
        self.variants = parameters["variants"]
    ...
    def select_model(self):
        switcher = {"small": torchvision.models.efficientnet_v2_s,
                    "medium": torchvision.models.efficientnet_v2_m,
                    "large":torchvision.models.efficientnet_v2_l}
        return switcher[self.variants](weights = "DEFAULT",  progress = True) 
    ...
    def calculate_test_loss(self):
        ...
        for epoch in range(self.Epochs):
            ...
            if epoch_number % self.SaveModelIterFreq == 0:
                path = "EfficientnetV2Models/model_{}epochs".format(epoch_number) + self.saveModelFormat
