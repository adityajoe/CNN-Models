...
class TrainModel():
    ...
    def select_model(self):
        switcher = {"small": "mobilenet_v3_small",
                    "large": "mobilenet_v3_large"}
        
        return switcher[self.variants]
    def dataset(self):
    ...
    def model_definition(self):
        ...
        self.model = torch.hub.load('pytorch/vision:v0.9.0', model_name, pretrained=True)
    ...
    def calculate_test_loss(self):
        ...
        for epoch in range(self.Epochs):
            ...
            if epoch_number % self.SaveModelIterFreq == 0:
                path = "MobilenetV3Models/model_{}epochs".format(epoch_number) + self.saveModelFormat
